...
function preload() {
    game.load.image('fallObject', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/shadow.png');
    game.load.image('ground', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/ground.png');
    game.load.image('menu', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/button3.png', 400, 90);
    game.load.image("bg", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/bg.png");
    game.load.image("cow", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/cow.png");
    game.load.image("chicken", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/chicken.png");
    game.load.image("background", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/sky.png");
    game.load.image("rules", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/rules.png");
    game.load.image("life", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/img/life.png");
}
...
function addBDD(name ,value){
    ...
    var request = $.ajax({
        url : 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/6/add.php',
        method : 'GET',
        data : data,
        dataType : 'html'
    });
...
function displayRules(grounds){
    if(rules_one === false){
        ...
        var regles = "Tom l'agriculteur n'est pas sûr du nombre de vaches qu'il a dans son enclos. Peux-tu l'aider ?       Utilises ta souris pour cliquer sur la bonne réponse à droite.";
