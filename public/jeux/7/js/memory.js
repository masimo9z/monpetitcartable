...
;(function( window ) {
  ...
  Memory.prototype.options = {
    ...
    cards : [
      {
        id : 1,
        img: "img/default/algeria.png"
      },
      {
        id : 2,
        img: "img/default/brazil.png"
      },
      {
        id : 3,
        img: "img/default/canada.png"
      },
      {
        id : 4,
        img: "img/default/china.png"
      },
      {
        id : 5,
        img: "img/default/france.png"
      },
      {
        id : 6,
        img: "img/default/germany.png"
      },
      {
        id : 7,
        img: "img/default/india.png"
      },
      {
        id : 8,
        img: "img/default/italy.png"
      },
      {
        id : 9,
        img: "img/default/japan.png"
      },
      {
        id : 10,
        img: "img/default/mexico.png"
      },
      {
        id : 11,
        img: "img/default/morocco.png"
      },
      {
        id : 12,
        img: "img/default/turkey.png"
      },
      {
        id : 13,
        img: "img/default/portugal.png"
      },
      {
        id : 14,
        img: "img/default/south_africa.png"
      },
      {
        id : 15,
        img: "img/default/usa.png"
      },
      {
        id : 16,
        img: "img/default/spain.png"
      }
    ],
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      ...
      <span class="mg__meta--moves">Mouvement(s) : \
      <span id="mg__meta--moves">' + this.numMoves + '</span>\
      </span>\
      </div>\
      <div class="mg__meta--right">\
      <button id="mg__button--restart" class="mg__button">Menu principal</button>\
      </div>';
    this.gameMeta.innerHTML = this.gameMetaHTML;
    this.game.appendChild(this.gameMeta);

    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading">Bienvenue dans le jeu Memory !</h2>\
      <p class="mg__start-screen--text">Retourne les cartes et trouves les deux cartes ayant leurs drapeaux identiques. Essaies de compléter le jeu avec le moins de mouvement possibles !</p>\
      <h3 class="mg__start-screen--sub-heading">Sélectionne un niveau</h3>\
      <ul class="mg__start-screen--level-select">\
      <li><span data-level="1">Niveau 1 - Facile (4 x 2)</span></li>\
      <li><span data-level="2">Niveau 2 - Moyen (6 x 3)</span></li>\
      <li><span data-level="3">Niveau 3 - Difficile (8 x 4)</span></li>\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      ...
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Sweet!</h2>\
        ...
        self.checkCardWin(this.numMoves);
  ...
  /**
   * Check if user won a card or no
   */
    
  Memory.prototype.checkCardWin = function(numMoves) {
    var self = this;
    if(numMoves <= this.chosenLevel*10){
    ...
    */
    ...
    Memory.prototype.addBDD = function(name ,value) {
        var data;
