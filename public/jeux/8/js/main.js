var model = {
    ...
    shape:{
        arrays:{
            arrShapeBox1:['cat', 'cat2', 'cat3', 'cat4', 'cat5', 'dog'],
            arrShapeBox2:['bird', 'bird2', 'bird3'],
            arrShapeBox3:['fish', 'fish2', 'fish3'],            
        },
        randomShape: null,
        randomShapeBox: null,
...
function preload(){
    ...
    $.each(model.shape.arrays, function(index, value) {
        for(i=0; i<model.shape.arrays[index].length; i++){
            ...
            self.load.image(model.shape.arrays[index][i], "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/"+model.shape.arrays[index][i]+".png");
        }
    });
    
    self.load.image('life', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/life.png');
    self.load.image("bg", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/bg.png");
    self.load.image('boxFly', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/boxFly.png');
    self.load.image('boxWalk', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/boxWalk.png');
    self.load.image('boxSwim', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/boxSwim.png');
    self.load.image('menu', 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/button3.png', 400, 90);
    self.load.image("rules", "https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/img/rules.png");
}
...
function addBDD(name ,value){
    ...
    var request = $.ajax({
        url : 'https://tp.iha.unistra.fr/projets/dweb02/laravel/monpetitcartable/public/jeux/8/add.php',
        method : 'GET',
        data : data,
        dataType : 'html'
    });
...
function displayRules(grounds){
    if(model.rules.rules_one === false){
        ...
        model.rules_text = game.add.text(model.width/2 - 120, 200, regles, { font: '18px Arial', fill: '#000'});
