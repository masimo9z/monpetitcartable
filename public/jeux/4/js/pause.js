...
var game = new Phaser.Game(800, 600, Phaser.AUTO, 'idGameDiv', { preload: preload, create: create });

var w = 800, h = 600;

function preload() {
    game.load.image('diamond', 'img/stars.png');
    game.load.image('menu', 'img/button.png', 270, 180);
}
